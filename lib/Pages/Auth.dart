...
class AuthorizationState extends State<Authorization> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Опитування якості обслуговування магазину Сіріус'),
          centerTitle: true,
        ),
        body: Column(
          ...
          children: [
            Text('Для початку введіть своє ім\'я та прізвище', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,),),
            Center(
              child: Container(
                  ...
                  if(_user != ''){
                    ...
                    showDialog<String>(
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        content: const Text('Поле для введення імені проходжувача опитування не може бути пустим!'),
                        actions: <Widget>[
                          TextButton(
